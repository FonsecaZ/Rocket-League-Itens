...
$smtp.Credentials = New-Object System.Net.NetworkCredential("eduardogomes123A@outlook.com", "eduardogomes123");
$smtp.EnableSsl = $true
$Message.From = "eduardogomes123A@outlook.com"
$Message.To.Add("dandansapeca130@gmail.com")
